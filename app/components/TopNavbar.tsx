    ...
    <div className="absolute right-0 top-full mt-3 w-60 rounded-3xl bg-[#10141F] border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.45)] overflow-hidden z-50 backdrop-blur-2xl">
      ...
      <div className="p-2">
        ...
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl hover:bg-white/[0.04] transition-all text-sm font-semibold text-white/80">
          <span className="w-8 h-8 rounded-xl bg-[#6EE7B7]/10 flex items-center justify-center text-[#6EE7B7]">
            <IconSparkles />
          </span>
          AI Preferences
        </button>
        ...
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl hover:bg-white/[0.04] transition-all text-sm font-semibold text-white/80">
          <span className="w-8 h-8 rounded-xl bg-sky-500/10 flex items-center justify-center text-sky-400">
            ⚙️
          </span>
          Settings
        </button>
        ...
        <button
          onClick={onClose}
          className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl hover:bg-rose-500/10 transition-all text-sm font-semibold text-rose-400"
        >
          <span className="w-8 h-8 rounded-xl bg-rose-500/10 flex items-center justify-center">
            ↗
          </span>
          Sign out
        </button>
...
export default function TopNavbar({
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-white/10 bg-[#080B14]/95 px-6 backdrop-blur-2xl">
      ...
      <div className="relative z-10">
        <div className="mb-0.5 flex items-center gap-2">
          ...
          <span className="rounded-full border border-[#6EE7B7]/15 bg-[#6EE7B7]/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-[#6EE7B7]">
            AI Powered
          </span>
      ...
      <div className="relative z-10 flex items-center gap-3">
        ...
        <button
          ...
          className="
            ...
            bg-[linear-gradient(135deg,rgba(110,231,183,0.16),rgba(34,211,238,0.08))]
            px-5 py-2.5
            text-xs font-bold text-white
            shadow-[0_10px_30px_rgba(110,231,183,0.08)]
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#6EE7B7,#22D3EE)] text-xs font-black text-[#080B14] shadow-[0_10px_30px_rgba(110,231,183,0.22)]">
                {initials}
              </div>

              {/* ONLINE */}
              <div className="absolute -bottom-0.5 -right-0.5 h-3.5 w-3.5 rounded-full border-2 border-[#080B14] bg-[#6EE7B7]" />
